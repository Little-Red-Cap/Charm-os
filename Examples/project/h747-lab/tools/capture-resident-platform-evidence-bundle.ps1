...
function Invoke-SelfTest {
    ...
    try {
        ...
        if ($ParsedQemu.Domain -ne "virtual_m7" -or
            ...
            $ParsedQemu.Loads -ne "hello_app=entry:0x20080021:span:270:segments:2:fits:1:probe:ok;packetstream:player_min=entry:0x20080001:span:1280:segments:3:fits:1:probe:ok;large_fit_app=entry:0x20080019:span:61696:segments:3:fits:1:probe:ok;bad_elf_magic_app=entry:0x00000000:span:0:segments:0:fits:1:probe:bad_magic;bad_class_app=entry:0x00000000:span:0:segments:0:fits:1:probe:bad_class;bad_endian_app=entry:0x00000000:span:0:segments:0:fits:1:probe:bad_endian;bad_program_header_app=entry:0x00000000:span:0:segments:0:fits:1:probe:bad_program_header;truncated_payload_app=entry:0x00000000:span:0:segments:0:fits:1:probe:truncated_payload;entry_outside_segment_app=entry:0x00000000:span:0:segments:0:fits:1:probe:entry_outside_segment;rwx_segment_app=entry:0x00000000:span:0:segments:0:fits:1:probe:rwx_segment;too_large_app=entry:0x00000000:span:82176:segments:2:fits:0:probe:load_buffer_too_small" -or
