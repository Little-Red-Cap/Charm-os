...
export namespace bsp::st7305 {
    ...
    constexpr PanelPreset kPresetYdp290h001V3{
        "ydp290h001_v3",
    ...
    constexpr PanelPreset kPresetYdp213h001V3{
        "ydp213h001_v3",
    ...
    constexpr PanelPreset kPresetYdp154h008V3{
        "ydp154h008_v3",
    ...
    constexpr PanelPreset kPresetW420hc018Mono12z{
        "w420hc018mono_12z",
    ...
    inline std::span<const PanelPreset> panel_presets() noexcept {
    ...
    inline const PanelPreset* find_panel_preset(std::string_view name) noexcept {
