...
#define AUDIO_PACKET_SZE(frq)          (uint8_t)((((((frq) + 999U) / 1000U) * AUDIO_SAMPLE_FRAME_BYTES) & 0xFFU)), \
                                       (uint8_t)((((((((frq) + 999U) / 1000U) * AUDIO_SAMPLE_FRAME_BYTES) >> 8) & 0xFFU)))
...
__ALIGN_BEGIN static uint8_t USBD_AUDIO_CfgDesc[USB_AUDIO_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x01,
  0x00,                                 /* bAssocTerminal */
  AUDIO_CHANNEL_COUNT,                  /* bNrChannels */
  0x03,                                 /* wChannelConfig 0x0003  Left Front, Right Front */
  0x00,
  0x00,                                 /* iChannelNames */
  0x00,                                 /* iTerminal */
  /* 12 byte*/
  ...
  AUDIO_CHANNEL_COUNT,                  /* bNrChannels */
  AUDIO_SUBFRAME_BYTE_COUNT,            /* bSubFrameSize */
