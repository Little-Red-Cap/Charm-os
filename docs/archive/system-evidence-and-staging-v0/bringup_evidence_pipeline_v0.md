...
Compiler lifecycle sidecar 可以只读投影本流水线已经导出的 evidence，见
[`compiler_lifecycle_summary_sidecar_contract_v0.md`](../../compiler/compiler_lifecycle_summary_sidecar_contract_v0.md)。
该投影不改变本流水线的状态或判决；旧 compiler law 讨论见
[`../compiler-law-v0/README.md`](../compiler-law-v0/README.md)。
...
### 8.4 I2C board evidence 历史样板

早期 board/package facts、I2C fact composition、WHOAMI mock 与 Host fixture
编排已归档到：

- [`../i2c-device-evidence-v0/README.md`](../i2c-device-evidence-v0/README.md)

这些样板只证明 evidence sidecar/tooling 形状，不是当前真实板状态或 I2C 公共契约。
