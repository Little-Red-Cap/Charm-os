...
The host executable writes `display_raster_demo.ppm` next to the executable, so
generated visual evidence stays under `cmake-build-*` instead of the source tree.
