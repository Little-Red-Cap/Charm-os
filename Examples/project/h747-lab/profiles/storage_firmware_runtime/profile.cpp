...
constexpr init::CapId kUsbMscCap = init::cap_id("h747.usb.msc");
constexpr init::CapId kAppCap = init::cap_id("h747.app.storage_firmware_runtime");
...
util::Result<void> init_app(void*) noexcept {
    h747::apps::storage_firmware_runtime::init();
    return {};
}
...
const Profile& active_profile() noexcept {
    static const Profile profile{
        ...
        h747::apps::storage_firmware_runtime::loop_once,
    };
    return profile;
}
