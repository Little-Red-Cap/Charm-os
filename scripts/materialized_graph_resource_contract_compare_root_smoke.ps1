...
Assert-Condition ([string]$rootSummaryInspectResult.fact_resolution_summary.kind -eq 'fact_resolution_summary/v0') 'artifact_root summary fact_resolution_summary kind mismatch'
Assert-Condition ([string]$rootSummaryInspectResult.fact_resolution_summary.mode -eq 'summary') 'artifact_root summary fact_resolution_summary mode mismatch'
Assert-Condition ([string]$rootSummaryInspectResult.comparison.fact_resolution_summary.kind -eq 'fact_resolution_summary/v0') 'artifact_root comparison fact_resolution_summary kind mismatch'
Assert-Condition ([string]$rootSummaryInspectResult.comparison.fact_resolution_summary.mode -eq 'comparison') 'artifact_root comparison fact_resolution_summary mode mismatch'
