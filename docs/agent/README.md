...
```text
AGENTS.md -> route -> relevant rules/contract -> skill/workflow -> optional template/glossary
```
...
- Route 不复制规则，skill 不覆盖规则，workflow 不复制 skill，template 不携带判断规则。
