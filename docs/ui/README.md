...
- `Examples/ui/vivid/page_transition_demo`：验证双页 `PageTransitionRunner` 的 normal commit、cancel、PixelSingle commit/cancel、low-budget static cut 与 prepare fail 收尾律。
