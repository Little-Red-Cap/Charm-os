...
set(CHARM_ARMV7A_COMMON_FLAGS
    "-mcpu=${CHARM_ARMV7A_CPU} -marm -ffreestanding -fdata-sections -ffunction-sections -fno-exceptions -fno-rtti -fno-threadsafe-statics -fno-use-cxa-atexit")

set(CMAKE_C_FLAGS_INIT "${CHARM_ARMV7A_COMMON_FLAGS}")
set(CMAKE_CXX_FLAGS_INIT "${CHARM_ARMV7A_COMMON_FLAGS}")
set(CMAKE_ASM_FLAGS_INIT "-mcpu=${CHARM_ARMV7A_CPU} -marm")
