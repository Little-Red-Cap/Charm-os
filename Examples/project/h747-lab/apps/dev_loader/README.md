...
the last packet/transport state. `dev usb abort` is the explicit cleanup path:
it stops/disconnects the USB device and resets the receive session instead of
