...
counts, EOF behavior, invalid open/read handling, and unsupported storage stubs are
regression-gated.
...
`store:storage_error_app`, `storage_open_error_app`,
`store:storage_open_error_app`, `unsupported_caps_app`, and
