...
Assert-RequiredPaths -Paths @($consumerWorkspaceScript, $selectorExportScript, $selectorValidateScript)

Push-Location $repoRoot
try {
    Invoke-PowerShellScript `
        -PowerShellExe $powerShellExe `
        -ScriptPath $consumerWorkspaceScript `
        -ArgumentList @(
    ...
    $consumerSummaryPath = Resolve-OpeningFlowConsumerSummaryPath -ConsumerWorkspaceRoot $consumerWorkspaceRootPath
