...
if (($handoffLog -notmatch "ARMv7-A handoff launch, target=0x[0-9A-F]{8}, arg0=0x[0-9A-F]{8}, mode=sys, state=arm, transfer=yes, hook=yes, capture=yes, invoke=yes, launch=yes")) {
