...
7. [`vivid_intent_to_artifact_evidence_v0.md`](vivid_intent_to_artifact_evidence_v0.md)
8. [`vivid_style_token_law_v0.md`](vivid_style_token_law_v0.md)
9. [`vivid_layer_runtime_v0.md`](vivid_layer_runtime_v0.md)
10. [`vivid_motion_runtime_v0.md`](vivid_motion_runtime_v0.md)
11. [`vivid_display_hotkeys.md`](vivid_display_hotkeys.md)
12. [`vivid_focus_evidence_boundary_v0.md`](vivid_focus_evidence_boundary_v0.md)
13. [`vivid_focus_transfer_evidence_v0.md`](vivid_focus_transfer_evidence_v0.md)
14. [`vivid_focus_scope_evidence_v0.md`](vivid_focus_scope_evidence_v0.md)
15. [`vivid_focus_semantic_evidence_v0.md`](vivid_focus_semantic_evidence_v0.md)
16. [`vivid_semantic_request_ledger_law_v0.md`](vivid_semantic_request_ledger_law_v0.md)
17. [`vivid_page_layer_style_patch.md`](vivid_page_layer_style_patch.md)
...
- `Examples/ui/vivid/semantic_action_admission_demo`: verifies Semantic Action Admission v0, including intent resolution, focus/click execution planning, planning-only side effects, unsupported action, disabled target, duplicate id, and invalid request statuses; stdout follows [`vivid_evidence_stdout_law.md`](vivid_evidence_stdout_law.md), guarded by CTest final `result=ok cases=7`.
- `Examples/ui/vivid/semantic_action_request_demo`: verifies Semantic Action Request v0, including controlled semantic activate execution, focus preparation, emitted click evidence, unsupported/focus-scope rejection, duplicate id, missing id, and request ledger evidence; stdout follows [`vivid_evidence_stdout_law.md`](vivid_evidence_stdout_law.md), guarded by CTest final `result=ok cases=6`.
