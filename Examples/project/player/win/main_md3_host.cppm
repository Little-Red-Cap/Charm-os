...
#include "main.font_probe.inc"
    ...
    PlayerRuntimeConfig build_runtime_config(player::PlayerPage start_page,
        ...
        app_cfg.ui_policy.font_mode = player::PlayerUiFontMode::FileFontsIfAvailable;
        app_cfg.ui_policy.cover_mode = player::PlayerUiCoverMode::DecodeIfAvailable;
        app_cfg.ui_policy.transition_mode = player::PlayerUiTransitionMode::AutoLayered;
        app_cfg.ui_policy.list_cover_cache_entries = 12;
        app_cfg.ui_policy.enable_perf_overlay = true;
        app_cfg.ui_resources.font = build_font_resources(font_ttf_path,
