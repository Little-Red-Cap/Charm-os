...
namespace {
    ...
    constexpr ManifestEntry kManifest[] = {
        {"page_transition_demo", "pt", 19, AxisMotion | AxisTransaction | AxisLayer | AxisRender | AxisAdmission | AxisCausal, "docs/ui/vivid_motion_runtime_v0.md"},
    ...
    constexpr unsigned kExpectedCaseTotal = 248;
