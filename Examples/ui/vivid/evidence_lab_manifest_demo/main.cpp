...
namespace {
    ...
    constexpr ManifestEntry kManifest[] = {
        ...
        {"semantic_action_request_demo", "sar", 8, AxisSemantic | AxisAdmission | AxisEdge | AxisFocus, "docs/ui/vivid_semantic_request_ledger_law_v0.md"},
        ...
        {"semantic_focus_request_demo", "sfr", 10, AxisSemantic | AxisFocus | AxisAdmission | AxisEdge | AxisRender, "docs/ui/vivid_semantic_request_ledger_law_v0.md"},
    ...
    constexpr unsigned kExpectedCaseTotal = 191;
