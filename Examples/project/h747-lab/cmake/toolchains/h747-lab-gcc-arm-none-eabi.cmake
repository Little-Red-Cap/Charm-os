...
if(_H747_LAB_ARM_GNU_BIN)
    set(CMAKE_C_COMPILER "${_H747_LAB_ARM_GNU_BIN}/arm-none-eabi-gcc.exe")
    set(CMAKE_CXX_COMPILER "${_H747_LAB_ARM_GNU_BIN}/arm-none-eabi-g++.exe")
    set(CMAKE_ASM_COMPILER "${_H747_LAB_ARM_GNU_BIN}/arm-none-eabi-gcc.exe")
    set(CMAKE_OBJCOPY "${_H747_LAB_ARM_GNU_BIN}/arm-none-eabi-objcopy.exe")
    set(CMAKE_SIZE "${_H747_LAB_ARM_GNU_BIN}/arm-none-eabi-size.exe")
else()
