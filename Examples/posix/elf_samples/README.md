...
| d_probe | elf:/fd_probe.elf /cat.txt | stdout: fd summary, exit=0 | fd 语义探针 (isatty/fstat + 错误路径) | RAMFS 文件输入 | 扩展到更多 fd 类型对照 |
...
2. 将 4 个样本的依赖逐步扩到 `read/open/close/fstat/isatty`
