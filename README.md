...
3. 跑示例：`Examples/shell/service_shell`
...
- `Examples/shell/service_shell`：Service + Shell + Module 示例
- `Examples/service/service_core`：Service 基础示例
- `Examples/service/service_ds_demo`：Service DS 示例
- `Examples/fs/fs_demo`：VFS + RAMFS 试验
- `Examples/fs/fs_vfs_demo`：VFS 组合示例
