...
> 状态：archived。本文保留早期 compare consumer 的字段展开、runner 用法与 explain-hop 设计讨论；
> 现行边界见 [`../../system/minimal_kernel_runtime_session_witness_inspect_compare_consumer_v0.md`](../../system/minimal_kernel_runtime_session_witness_inspect_compare_consumer_v0.md)。
