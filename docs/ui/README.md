...
- `Examples/ui/vivid/page_transition_demo`：验证双页 `PageTransitionRunner` 的 normal commit、cancel、Static/None profile、PixelSingle commit/cancel/interrupt、CommandSnapshot static-cut 与 prepare fail 收尾律。
