...
| render/draw/scene evidence | [`vivid_render_evidence_chain_v0.md`](vivid_render_evidence_chain_v0.md)、[`vivid_draw_cmd_evidence_boundary_v0.md`](vivid_draw_cmd_evidence_boundary_v0.md)、[`vivid_scene_support_boundary_v0.md`](vivid_scene_support_boundary_v0.md) |
