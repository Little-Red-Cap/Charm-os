...
- 对用户程序暴露最小 facade：
  - `read/write/open/close/dup/dup2/fcntl(F_DUPFD/F_GETFD/F_SETFD)/pipe`
  - `fstat/isatty/lseek`
...
- I/O / 进程 / offset：`_read`、`_write`、`_close`、`_open`、`_fstat`、`_stat`、`_isatty`、`_lseek`、`_getpid`、`_kill`、`_fcntl(F_DUPFD/F_GETFD/F_SETFD)`
