...
- POSIX 执行面：`posix_*`
- System compiler / explain surface：`artifact_report_v0`、`resource_contract_v0`、`explain_surface_v0`、`bringup_evidence_pipeline_v0`、`board_evidence_fixture_catalog_v0`、`i2c_board_probe_evidence_readiness_checklist_v0`
