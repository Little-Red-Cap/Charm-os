...
if (($log -notmatch "ARMv7-A handoff launch, target=0x[0-9A-F]{8}, arg0=0x[0-9A-F]{8}, mode=sys, state=arm, transfer=yes, hook=yes, probe=yes, arg0=yes, stack=yes, branch=yes, return=yes, invoke=yes, launch=yes")) {
