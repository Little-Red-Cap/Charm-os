...
def build_report(summary: dict) -> str:
    ...
    lines: list[str] = [
        ...
        f"- Opening reason: `{entry_status['opening_reason']['kind']}` drift_changed=`{entry_status['opening_reason']['drift_changed']}` verdict=`{entry_status['opening_reason']['drift_verdict'] or 'none'}`",
...
def build_check(summary: dict) -> str:
    ...
    return "\n".join(
        [
            ...
            f"opening_reason_kind: {entry_status['opening_reason']['kind']}",
            f"opening_reason_drift_changed: {entry_status['opening_reason']['drift_changed']}",
            f"opening_reason_drift_verdict: {entry_status['opening_reason']['drift_verdict']}",
