...
module charm.ui.scene:snapshot_store;
...
namespace ui::scene::detail {
    ...
    inline constexpr std::uint32_t invalid_snapshot_payload_slot = 0xFFFFFFFFu;
    ...
    struct SnapshotRecord {
        ...
        std::uint32_t payload_slot{invalid_snapshot_payload_slot};
    ...
    public:
        ...
        [[nodiscard]] LayerComposeResult compose_dry_run(
            const LayerComposeSpec& spec) noexcept {
    ...
    private:
        static constexpr std::uint32_t snapshot_record_bytes(
            const SnapshotRecord& slot) noexcept {
