...
#define CHARM_IO_REGISTRY_WEAK __attribute__((weak))
#else
#define CHARM_IO_REGISTRY_WEAK
#endif

extern "C" CHARM_IO_REGISTRY_WEAK void charm_io_registry_debug_exist(const char*, util::u32) noexcept {
}

#undef CHARM_IO_REGISTRY_WEAK
