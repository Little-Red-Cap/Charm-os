...
> 状态：archived。本文保留早期总证据链的完整产物树、旁路 smoke、CI 参数与阶段验收说明；
> 现行契约见 [`../../system/minimal_kernel_runtime_evidence_bundle_contract.md`](../../system/minimal_kernel_runtime_evidence_bundle_contract.md)。
