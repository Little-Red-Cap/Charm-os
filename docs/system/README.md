...
- 子主题契约：[`posix_program_image_contract.md`](posix_program_image_contract.md)、[`posix_spawn_contract.md`](posix_spawn_contract.md)、[`posix_fd_table_contract.md`](posix_fd_table_contract.md)、[`posix_error_semantics.md`](posix_error_semantics.md)
